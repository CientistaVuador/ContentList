...
public class EntryProperties extends javax.swing.JDialog {
    ...
    private void initEntries(FileEntry[] entries) {
        ...
        this.accessedField.setText("(unavailable)");
        ...
        this.accessedField.setEnabled(false);
        ...
        if (entry.getPath().isRoot()) {
            ...
            String name = metadata.readString(FileEntry.METADATA_NAME);
            String author = metadata.readString(FileEntry.METADATA_AUTHOR);
            String description = metadata.readString(FileEntry.METADATA_DESCRIPTION);
            
            if (name != null) {
                this.metadataNameField.setText(name);
            }
            if (author != null) {
                this.metadataAuthorField.setText(author);
            }
            if (description != null) {
                this.metadataDescriptionField.setText(description);
            }
        }
        ...
        this.accessedField.setEnabled(true);
        this.sizeField.setEnabled(true);
        ...
        this.accessedField.setText(UIUtils.asShortLocalizedDateTime(entry.getAccess()));
    ...
    public void removeMetadataPanel() {
        this.jTabbedPane1.remove(this.metadataPanel);
    }
    ...
    private void initComponents() {
        ...
        metadataDescriptionField = new javax.swing.JTextArea();
        ...
        accessedField = new javax.swing.JTextField();
        ...
        metadataNameField.setEditable(false);

        jLabel10.setText("Author:");

        metadataAuthorField.setEditable(false);

        jLabel11.setText("Description:");

        metadataDescriptionField.setEditable(false);
        metadataDescriptionField.setColumns(20);
        metadataDescriptionField.setRows(5);
        jScrollPane2.setViewportView(metadataDescriptionField);
        ...
        metadataPanelLayout.setHorizontalGroup(
            ...
            .addGroup(metadataPanelLayout.createSequentialGroup()
                ...
                .addGroup(metadataPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(metadataNameField)
        ...
        jTabbedPane1.addTab("Info", metadataPanel);
        ...
        jLabel12.setText("Accessed On:");

        accessedField.setEditable(false);
        accessedField.setText("2024/12/05 16:64");
        accessedField.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(accessedField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(12, 12, 12)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private javax.swing.JTextField accessedField;
    ...
    private javax.swing.JTextArea metadataDescriptionField;
